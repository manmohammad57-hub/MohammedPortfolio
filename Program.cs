...
.AddDefaultUI(); // includes Identity UI (login/register pages)
...
//  Create default Admin user & role at startup
...
using (var scope = app.Services.CreateScope())
{
    ...
    {
        throw new Exception("Admin configuration is missing in appsettings.");
    }
...
else if (!app.Environment.IsEnvironment("Docker"))
{
    ...
    app.UseHsts(); // Only outside Docker
}
